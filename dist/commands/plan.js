...
import { interpretEscapes, stripFrontmatter, toNonEmptyString, toNonNegativeInteger, toPositiveInteger, toSafeFileName, deleteIfTempFile, } from '../utils/parsers.js';
import { assignPlan, createPlan, deletePlan, finishPlanLifecycle, getPlan, getPlanDependencies, getPlanStatus, listPlans, patchPlanStatus, startPlanLifecycle, updatePlan, } from '../api/plan.js';
...
export async function executePlanCommand(apiUrl, projectId, headers, action, options) {
    switch (action) {
        ...
        case 'create': {
            ...
            return withSpinner('Creating plan...', () => createPlan(apiUrl, projectId, headers, {
                title: options.title,
                content,
                type: options.type,
