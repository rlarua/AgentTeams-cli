...
import { createPostMortem, deletePostMortem, getPostMortem, listPostMortems, updatePostMortem, } from '../api/postmortem.js';
...
export async function executePostMortemCommand(apiUrl, headers, action, options) {
    ...
    switch (action) {
        ...
        case 'create': {
            ...
            if (!options.content)
                throw new Error('--content or --file is required for postmortem create');
            ...
            return withSpinner('Creating post-mortem...', async () => {
        ...
        case 'download': {
            if (!options.id)
                throw new Error('--id is required for postmortem download');
            const projectRoot = (() => {
            ...
            return withSpinner('Downloading post-mortem...', async () => {
