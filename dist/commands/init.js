...
export function buildAuthorizeUrl(port, projectName, authPathEnc, osType) {
...
export async function executeInitCommand(options) {
    ...
    try {
        ...
        const conventionContent = await withSpinner('Fetching convention template...', () => fetchConventionTemplate(authResult));
