...
export async function executeReportCommand(apiUrl, headers, action, options) {
    ...
    switch (action) {
        ...
        case 'create': {
            ...
            if (filesModified !== undefined)
                body.filesModified = filesModified;
            if (linesAdded !== undefined)
                body.linesAdded = linesAdded;
            if (linesDeleted !== undefined)
                body.linesDeleted = linesDeleted;
            if (durationSeconds !== undefined)
                body.durationSeconds = durationSeconds;
            if (commitStart !== undefined)
                body.commitStart = commitStart;
            if (commitEnd !== undefined)
                body.commitEnd = commitEnd;
            if (pullRequestId !== undefined)
                body.pullRequestId = pullRequestId;
            ...
            return withSpinner('Creating report...', async () => {
        ...
        case 'download': {
            if (!options.id)
                throw new Error('--id is required for report download');
            const projectRoot = (() => {
            ...
            return withSpinner('Downloading report...', async () => {
